                                            ...
                                            <select type="text" name="classname" class="form-control" id="class_id" placeholder="Class" required="">
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = mysqli_fetch_array($result)) { ?>
                                                        <option value="<?php echo $row["id"]; ?>" <?php if ($classname == $row["id"]) {
                                                                                                        echo "Selected";
                                                                                                    } ?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="subjectname" id="subject_id" class="form-control" placeholder="subject" required="">
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = mysqli_fetch_array($result)) { ?>
                                                        <option value="<?php echo $row["id"]; ?>" data-id="<?php echo $row["class_id"]; ?>" <?php if ($subjectname == $row["id"]) {
                                                                                                                                                echo "selected";
                                                                                                                                            }
                                                                                                                                            if ($row["class_id"] !== $classname) {
                                                                                                                                                echo 'style="display: none;"';
                                                                                                                                            } ?> <?php if ($subjectname == $row["id"]) {
                                                                                                                                                                                                                                                                            echo "Selected";
                                                                                                                                                                                                                                                                        } ?>>
